...
Amb les **HTTP Only, Secure i SameSite=Strict cookies** ja estàvem més tranquils. Però calia un pas més: **encriptar els tokens d'accés _abans_ de guardar-los a la cookie!**
