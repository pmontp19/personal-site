...
2. **Compressió**: L'mp3 es comprimeix (mono, 16kHz, 24kbps) perquè cap en 25MB — el límit de [Groq](https://groq.com/).

3. **Transcripció**: [Whisper de Groq](https://console.groq.com/docs/api-reference) transcriu l'àudio. Tot i que el català no és el seu fort, funciona prou bé.
...
7. **Frontend**: Un site fet amb [Astro](https://astro.build/) llegeix el JSON a build time i genera una pàgina on pots consultar totes les recomanacions per episodi.
...
- **Backend**: Python, [Groq API](https://console.groq.com/docs/api-reference), SQLite
